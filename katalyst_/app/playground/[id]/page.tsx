// katalyst_/app/playground/[id]/page.tsx
"use client";
...
const MainPlaygroundPage = () => {
  ...
  // === WRAP WITH YJS PROVIDER FOR COLLABORATION ===
  return (
    <YjsProvider
      config={{
        roomName: `playground-${id}`,
        username,
        userColor,
      }}
            ...
            <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
              ...
              <div className="flex flex-1 items-center gap-2">
                ...
                <div className="flex items-center gap-1">
                  {/* === NEW: Active Users Display === */}
                  {collaborationEnabled && <ActiveUsers />}

                  {/* === NEW: Collaboration Toggle === */}
                  <CollaborationToggle
                    isEnabled={collaborationEnabled}
                    onToggle={setCollaborationEnabled}
                  />
